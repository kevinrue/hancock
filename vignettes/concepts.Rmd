...
**Qualitative signatures** may be defined as those comprising lists of gene identifiers that are known to be either present or absent in a given population of cells.

**Quantitative signatures** may be define as either full transcriptional profiles of cell populatitons, or gene lists accompanied with quantitative gene expression information (e.g., TPM).
