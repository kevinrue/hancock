...
## Lists of marker names using `GSEABase` {#gseabaselist}
...
## Tibbles of markers using `GeneSet`
...
Conveniently, this package makes the definition of gene sets as simple as the use of `list` described [above](#gseabaselist).
